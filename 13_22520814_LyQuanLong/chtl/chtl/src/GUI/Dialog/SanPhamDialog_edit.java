 ...
 * @author admin
 */
public class SanPhamDialog_edit extends javax.swing.JDialog {

    String localMasp;
    
    public SanPhamDialog_edit(String masp) {
        //super(parent, modal);
        localMasp = masp;
        initComponents();
