 ...
 * @author admin
 */
public class KhuyenMaiDialog_edit extends javax.swing.JDialog {
    
    String localMaKm;

    public KhuyenMaiDialog_edit(String makm) {
        //super(parent, modal);
        localMaKm = makm;
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Sửa khuyến mãi");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       KhuyenMaiBUS kmbus = new KhuyenMaiBUS();
        ...
        JOptionPane.showMessageDialog(this, "Chiết khấu không hợp lệ", "Lỗi", JOptionPane.ERROR_MESSAGE);
        return;
        }
        try {
    ...
    public void setText(String maSP, String Ctkm, String chietKhau, String ngayBD, String ngayKT){
        ...
        textFieldTenKM.setText(Ctkm);
        textFieldCK.setText(chietKhau);
        textFieldNgayBD.setText(ngayBD);
        textFieldNgayKT.setText(ngayKT);
    }
    /**
