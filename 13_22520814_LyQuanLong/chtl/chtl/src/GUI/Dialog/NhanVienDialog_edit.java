 ...
 * @author admin
 */
public class NhanVienDialog_edit extends javax.swing.JDialog {
    String localMaNV;

    public NhanVienDialog_edit(String maNV) {
        //super(parent, modal);
        localMaNV =maNV;
        initComponents();
    ...
    private void initComponents() {
        ...
        panelRound1.setPreferredSize(new java.awt.Dimension(500, 750));
        ...
        textFieldTenNV.setPreferredSize(new java.awt.Dimension(200, 34));
        ...
        jButton1.setText("Sửa nhân viên");
    ...
    textFieldNgaySDT.setText(sdt);
    textFieldLuong.setText(luong);
    textFieldMK.setText(password);
}
