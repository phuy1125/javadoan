 ...
 * @author admin
 */
public class KhachHangDialog_edit extends javax.swing.JDialog {
    public String localMaKH;
    
    public KhachHangDialog_edit(String maKH) {
        //super(parent, modal);
        localMaKH = maKH;
        initComponents();
    ...
    public void setText(String tenKH,String gioiTinh ,String ngaySinh){
